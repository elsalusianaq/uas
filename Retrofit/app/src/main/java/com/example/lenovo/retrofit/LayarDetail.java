...
public class LayarDetail extends AppCompatActivity {
    ...
    EditText edtIdPembelian, edtIdPembeli, edtTanggalBeli, edtIdTup, edtTotalHarga;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtIdTup = (EditText) findViewById(R.id.edtIdTup);
        ...
        edtIdTup.setText(mIntent.getStringExtra("id_tup"));
